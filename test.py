...
class MyWindow(QMainWindow):
    ...
    def capture_image(self):
        ...
        while True:
            ...
            if k % 256 == 32:  # Space key to capture image
                ...
                masked_filename = 'masked/masked_{}.png'.format(self.img_counter)
    ...
    def send_email(self):
        ...
        if recipient_name and recipient_email:
            ...
            sender_email = "sabbir.ahmed1925@gmail.com"
            password = "gbyf wcqe mtyd mqiz "
            # sender_email = "vmilab.cse.just@gmail.com"
            # password = "fajp jqld miwi iics"
            ...
            try:
                ...
                if file_list:
                    ...
                    base_name = f"{recipient_name.capitalize()}.jpeg"
                    save_path = os.path.join(save_directory, base_name)

                    counter = 0
                    while os.path.exists(save_path):
                        counter += 1
                        base_name = f"{recipient_name.capitalize()}{counter}.jpeg"
                        save_path = os.path.join(save_directory, base_name)
